...
Security fixes are applied to the latest released Fenrir Agent version.
...
Fenrir Agent treats agent permission bypasses, trusted-workspace escapes, secret
exposure, sandbox escapes, and unsafe session/tool-data execution as security
issues.

## Security model

Fenrir Agent is for trusted workspaces. Tool calls are permission-gated; shell work
